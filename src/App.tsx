        ...
        <div>
          ...
          >
            ...
            <div className="relative z-10 flex flex-col min-[380px]:flex-row min-[380px]:items-center justify-between gap-2.5">
              <div className="flex items-center gap-2">
                <div className="bg-purple-707 bg-purple-700 text-white rounded-xl p-2 font-black tracking-widest text-[10px] sm:text-xs flex items-center justify-center shadow select-none shrink-0">
                  S·O·S
                </div>
                <div>
                  <div className="flex items-center gap-1.5 align-middle">
                    <h1 className="text-sm font-black tracking-tight text-neutral-950 dark:text-zinc-100 font-heading uppercase leading-none">
                      {lang === "pt" ? "Salva-me" : "Save Me"}
                    </h1>
                    {!isOnline && (
                      <span 
                        id="offline-badge" 
                        className="px-1.5 py-0.5 inline-flex items-center gap-0.5 rounded-md bg-amber-100 text-amber-800 border border-amber-200 text-[8px] font-black animate-pulse select-none"
                      >
                  ...
                  <p className="text-[9px] leading-tight text-purple-700 dark:text-purple-400 font-mono tracking-wider uppercase font-bold mt-0.5 max-w-[200px] min-[380px]:max-w-none">
              ...
              <div className="flex flex-wrap items-center gap-1.5 min-[380px]:justify-end">
                ...
                <button
                  ...
                  className="p-1 px-1.5 min-[380px]:px-2 inline-flex items-center gap-1 rounded-lg border border-purple-200 bg-purple-50 text-purple-700 hover:bg-purple-100 transition duration-200 text-[10px] font-bold cursor-pointer"
                ...
                <button
                  ...
                  className="p-1 px-1.5 rounded-lg border border-purple-200 dark:border-zinc-700 bg-purple-50 dark:bg-zinc-800 text-purple-700 dark:text-zinc-200 hover:bg-purple-100 dark:hover:bg-zinc-700 transition duration-200 text-[10px] font-black cursor-pointer flex items-center gap-1 shrink-0"
                  title={theme === "light" ? (lang === "pt" ? "Ativar Modo Escuro" : "Switch to Dark Mode") : (lang === "pt" ? "Ativar Modo Claro" : "Switch to Light Mode")}
                >
                  {theme === "light" ? (
                    <>
                      <Moon className="h-3.5 w-3.5" />
                      <span className="hidden min-[380px]:inline uppercase text-[9px]">{lang === "pt" ? "Escuro" : "Dark"}</span>
                    </>
                  ) : (
                    <>
                      <Sun className="h-3.5 w-3.5 animate-spin-slow" />
                      <span className="hidden min-[380px]:inline uppercase text-[9px]">{lang === "pt" ? "Claro" : "Light"}</span>
                    </>
                  )}
                </button>
                ...
                <button
                  ...
                  className="p-1 px-1.5 rounded-lg border border-purple-200 bg-purple-50 text-purple-700 hover:bg-purple-100 transition duration-200 text-[10px] font-black cursor-pointer flex items-center gap-1 shrink-0"
                  title={lang === "pt" ? "Change interface layout to English" : "Traduzir a interface para Português"}
                >
                  <Languages className="h-3.5 w-3.5" />
                  <span className="hidden min-[380px]:inline uppercase text-[9px]">{lang}</span>
                </button>
