        ...
        {!selectedSituation ? (
          ...
          >
              ...
              <div className="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div className="space-y-2">
                  <div className="flex items-center gap-2">
                    <span className="p-1 px-2.5 bg-purple-100 dark:bg-purple-950/40 text-purple-700 dark:text-purple-300 rounded-lg text-[10px] font-bold tracking-wider uppercase font-mono border border-purple-200 dark:border-purple-900/50">
                      {lang === "pt" ? "DIÁRIO" : "DAILY HUB"}
                    </span>
                    <span className="text-xs text-neutral-600 dark:text-zinc-400 font-medium">
                  ...
                  <p className="text-xs text-neutral-600 dark:text-zinc-400 leading-relaxed max-w-sm">
                    {lang === "pt" 
            ...
            <div className="space-y-3">
              <span className="text-[10px] font-bold uppercase font-mono text-neutral-500 dark:text-zinc-400 tracking-wider block">
              ...
              <div className="flex flex-wrap gap-1.5 overflow-x-auto pb-1">
                {[
                  ...
                  <button
                    ...
                    className={`px-3.5 py-2 rounded-full text-xs font-bold transition-all transform active:scale-95 whitespace-nowrap border ${
            ...
            <div className="relative flex items-center gap-2">
              <div className="relative flex-1">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 bg-neutral-50 dark:bg-zinc-800 hover:bg-neutral-100 dark:hover:bg-zinc-750 focus:bg-white dark:focus:bg-zinc-800 text-xs border border-neutral-200 dark:border-zinc-700 focus:border-purple-600 dark:focus:border-purple-500 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-200 transition-all font-medium text-neutral-950 dark:text-zinc-100"
                />
                {searchQuery && (
                  <button 
                ...
                <div className="flex flex-wrap gap-1">
                  {tags.slice(0, 12).map((tg) => (
                    <button
                      ...
                      className={`px-2.5 py-1 rounded-lg text-[10px] font-bold uppercase tracking-tight transition-all ${
                        selectedTag === tg.tag
              ...
              {loading ? (
                ...
                <div className="p-6 text-center space-y-5 rounded-2xl border border-dashed border-neutral-300 dark:border-zinc-750 bg-neutral-50/50 dark:bg-zinc-800/30">
                  ...
                  <div className="space-y-1">
                    <h3 className="text-sm font-bold text-neutral-900 dark:text-zinc-100">
                      {lang === "pt" ? "Nenhum cenário cadastrado ainda" : "No scenario registered yet"}
                    </h3>
                    <p className="text-xs text-neutral-600 dark:text-zinc-400 max-w-xs mx-auto">
                      {lang === "pt"
                  ...
                  <form onSubmit={handleSuggest} className="p-4 bg-white dark:bg-zinc-800 rounded-xl border border-neutral-200 dark:border-zinc-700 text-left space-y-3">
                    <div className="space-y-1.5">
                      ...
                      <input 
                        ...
                        className="w-full px-3 py-2 bg-neutral-50 dark:bg-zinc-900 border border-neutral-200 dark:border-zinc-700 focus:border-purple-600 rounded-lg text-xs placeholder-neutral-400 dark:placeholder-zinc-500 dark:text-zinc-100 focus:outline-none"
                      />
                    </div>
                    ...
                    <div className="space-y-1.5">
                      ...
                      <textarea
                        ...
                        className="w-full px-3 py-2 bg-neutral-50 dark:bg-zinc-900 border border-neutral-200 dark:border-zinc-700 focus:border-purple-600 rounded-lg text-xs placeholder-neutral-400 dark:placeholder-zinc-500 dark:text-zinc-100 focus:outline-none resize-none h-14"
                      />
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-2 items-center">
                      <div className="space-y-1">
                        ...
                        <select
                          ...
                          className="w-full bg-neutral-50 dark:bg-zinc-900 border border-neutral-200 dark:border-zinc-700 text-xs rounded-lg p-1.5 dark:text-zinc-200 focus:outline-none"
                        >
                      ...
                      <button
                        ...
                        className="w-full mt-3 py-2.5 bg-purple-700 hover:bg-purple-855 text-white font-bold rounded-lg text-xs transition duration-200 disabled:opacity-50"
                      >
                  ...
                  {situations.map((sit) => {
                    ...
                    return (
                      ...
                      >
                        <div className="space-y-2">
                          {/* Upper row */}
                          <div className="flex items-center justify-between text-[10px] font-mono font-bold tracking-tight">
                            <span className="text-purple-700 dark:text-purple-300 font-bold bg-purple-50 dark:bg-purple-950/40 px-2 py-0.5 rounded-md border border-purple-100 dark:border-purple-900/50">
                            ...
                            <div className="flex items-center gap-2">
                              <span className={`inline-flex items-center gap-1.5 px-2 py-0.5 rounded-md ${safety.bg} ${safety.text} border ${safety.border}`}>
                          ...
                          {/* Title text */}
                          <div className="text-neutral-900 dark:text-zinc-100 group-hover:text-purple-700 dark:group-hover:text-purple-400 font-heading font-extrabold text-[14px] leading-snug tracking-tight">
                            “{sit.trigger}”
                          </div>
                        </div>
                        ...
                        <div className="flex flex-wrap items-center justify-between gap-2.5 pt-2 border-t border-neutral-100/60 dark:border-zinc-750 mt-1">
                          <div className="flex flex-wrap gap-1 select-none">
                            {sit.tags?.slice(0, 3).map((tg) => (
                              <span key={tg} className="text-[9px] font-mono text-neutral-400 dark:text-zinc-400 bg-neutral-50 dark:bg-zinc-900 px-1.5 py-0.5 rounded border border-transparent dark:border-zinc-750 shrink-0">
                                #{tg.toLowerCase()}
                              </span>
                            ))}
                          </div>
                          <span className="text-[10px] text-purple-600 dark:text-purple-400 font-bold group-hover:translate-x-1 duration-200 transition-transform shrink-0">
          ...
          >
            ...
            <div className="flex items-center justify-between py-2 border-b border-neutral-100 dark:border-zinc-800">
              <button
                ...
                className="inline-flex items-center gap-1.5 text-xs font-bold text-neutral-600 dark:text-zinc-400 hover:text-purple-700 dark:hover:text-purple-400 cursor-pointer"
              >
              ...
              <button
                ...
                className="p-2 rounded-full hover:bg-neutral-100 dark:hover:bg-zinc-800 transition duration-200 cursor-pointer"
            ...
            <div className="space-y-3">
              <div className="flex flex-wrap items-center gap-2">
                <span className="text-[10px] font-mono font-bold uppercase py-0.5 px-2.5 bg-purple-50 dark:bg-purple-950/40 border border-purple-100 dark:border-purple-900/50 text-purple-700 dark:text-purple-300 rounded-md">
                ...
                <span 
                  ...
                  className={`inline-flex items-center gap-1.5 px-2 py-0.5 rounded-md text-[10px] font-bold uppercase tracking-wide border ${getSafetyDetails(selectedSituation.seguranca).bg} ${getSafetyDetails(selectedSituation.seguranca).text} ${getSafetyDetails(selectedSituation.seguranca).border}`}
                >
              ...
              <h1 
                ...
                className="text-xl sm:text-2xl font-black text-neutral-950 dark:text-zinc-100 font-heading leading-tight tracking-tight selection:bg-purple-200"
              >
                “{selectedSituation.trigger}”
              </h1>
            </div>
            ...
            {selectedSituation.notas && (
              <div className="p-4 bg-purple-50/50 dark:bg-purple-950/20 rounded-2xl border border-purple-100 dark:border-purple-900/40 font-sans text-xs text-neutral-700 dark:text-zinc-300 leading-relaxed space-y-1.5">
                <span className="text-[9px] uppercase font-bold tracking-wider font-mono text-purple-800 dark:text-purple-300 flex items-center gap-1.5">
            ...
            <div className="space-y-3">
              <span className="text-[10px] uppercase font-mono tracking-wider font-black text-neutral-500 dark:text-zinc-400 block">
              ...
              <div className="grid grid-cols-1 gap-4">
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-neutral-200/40 dark:border-zinc-750/50 pb-2 -mt-1">
                        <span className={`self-start px-2 py-0.5 rounded text-[9px] uppercase font-mono font-bold tracking-wider border ${tone.badge}`}>
                          {tone.label}
                        </span>
                        ...
                        <div className="flex items-center gap-1.5 flex-wrap">
                          ...
                          <span 
                            ...
                            className="inline-flex items-center gap-0.5 px-1.5 py-0.5 rounded text-[8px] font-bold font-mono bg-purple-50 dark:bg-purple-950/30 text-purple-700 dark:text-purple-300 border border-purple-150 dark:border-purple-900/40"
                          >
                          ...
                          <span 
                            className={`inline-flex items-center gap-0.5 px-1.5 py-0.5 rounded text-[8px] font-bold font-mono border ${getCommunityFeedbackStats(selectedSituation.id, tone.key).safetyColor}`}
                          >
                      ...
                      <div className="flex flex-wrap gap-1.5 pt-2 border-t border-neutral-200/40">
                        ...
                        <button
                          ...
                          className={`flex-1 min-w-[70px] inline-flex items-center justify-center gap-2 px-3 py-3 rounded-lg border text-[10px] font-black uppercase tracking-wider transition duration-200 cursor-pointer ${
                            isCopied
                      ...
                      <div className="pt-2.5 border-t border-neutral-200/40 dark:border-zinc-750 flex items-center justify-between text-[10px] font-medium text-neutral-500 dark:text-zinc-400">
                ...
                <div
                  className="col-span-1 sm:col-span-2 p-4.5 rounded-2xl border border-purple-200 dark:border-purple-900 bg-purple-50/15 dark:bg-purple-950/10 flex flex-col justify-between gap-3.5 transition-all duration-300 shadow-sm"
                >
                  {/* Header Badge */}
                  <div className="flex items-center justify-between">
                    <span className="px-2 py-0.5 bg-purple-100 dark:bg-purple-950/50 text-purple-700 dark:text-purple-300 rounded text-[9px] uppercase font-mono font-bold tracking-wider border border-purple-200 dark:border-purple-900 select-none">
                  ...
                  <motion.div
                    ...
                    transition={{ duration: 0.6, ease: "easeOut" }}
                    className="p-2 -mx-2 rounded-lg text-xs font-semibold text-neutral-700 dark:text-zinc-300 leading-relaxed break-words selection:bg-purple-200"
                  >
                    {lang === "pt"
                  ...
                  <div className="flex flex-wrap gap-1.5 pt-2 border-t border-neutral-200/40">
                    ...
                    <button
                      ...
                      className={`flex-1 min-w-[100px] inline-flex items-center justify-center gap-2 px-3 py-3 rounded-lg border text-[10px] font-black uppercase tracking-wider transition duration-200 cursor-pointer shadow-sm ${
